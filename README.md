...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/graphvite-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/graphvite-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add graphvite graphvite-mini
# for installing globally
pixi global install graphvite graphvite-mini
```
...
It is possible to list all of the versions of `graphvite` available on your platform:
...
```
pixi search graphvite --channel conda-forge
```
